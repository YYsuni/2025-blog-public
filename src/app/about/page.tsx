...
export default function Page() {
	const features = [
		...
		{
			title: '工作经历',
			description: '2008~2009/电路板厂：电子工程师（香港明日国际旗下）,2009~2014/华为OD：需求分析、初级项目经理（中软国际-辗转三地：深圳、南京、武汉）,2015~2018/操作系统（主营）：文档、社区运营、产品经理（深度科技、统信软件2020-2021二进宫）,2019~2020/PMS行业（公寓）：产品经理（中国平安旗下）,2021~至今/操作系统（围绕）：一个会编（AI）码（Code）的商务、产品、运营、测试的项目经理（锂钠氪锶）',
			icon: '🚀'
		}
/*		{
			title: 'UI 编辑',
